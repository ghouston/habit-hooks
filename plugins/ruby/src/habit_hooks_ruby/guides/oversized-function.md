...
Find true responsibility boundaries rather than splitting at the threshold: `helper_a` / `helper_b` carved off purely to fit the line count is one responsibility wearing two names.
